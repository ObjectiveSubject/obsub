...
<section id="solution" class="page-section ">
	...
	<div class="outer-container">
		<div class="inner-container">
			<p class="mt-4">The visual identity system can be applied to publications created with partners, to a greater or lesser degree depending on the relationship.</p>
		</div>
	</div>
