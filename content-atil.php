<section id="opportunity" class="page-section">
	...
	<figure class="alignnone">
		<div class="parallax-container">
			...
			<img src="<?php echo os_path('LA-Mayor.jpg', 'atil') ?>" srcset="<?php echo os_path('LA-Mayor.jpg', 'atil') ?> 1x, <?php echo os_path('LA-Mayor@2x.jpg', 'atil') ?> 2x" width="1600" height="1008" alt="Los Angeles Mayor Eric Garcetti at the Measure M victory press conference">
		</div>
...
<section id="solution" class="page-section ">
	...
	<figure class="aligncenter cycle-images">
		<div class="outer-container">
			<img class="img-1" src="<?php echo os_path('ATIL-Chapter-Mockup.png', 'atil') ?>" width="1212" height="978" srcset="<?php echo os_path('ATIL-Chapter-Mockup.png', 'atil') ?> 1x, <?php echo os_path('ATIL-Chapter-Mockup@2x.png', 'atil') ?> 2x" width="1600" height="1008" alt="TransitCenter’s All Transportation is Local chapters" >
		</div>
			...
			<div class="flex-blocks">
				<div class="column column-span-3">
					...
					<div class="block-caption">
						<p>Ydanis Rodriguez</p>
						<p><em>NYC Council Transport Committee Chair</em></p>
					</div>
				</div>
				...
				<div class="column column-span-3">
					...
					<div class="block-caption">
						<p>Stephanie Howse</p>
						<p><em>Ohio State Representative</em></p>
					</div>
				</div>
				...
				<div class="column column-span-3">
					...
					<div class="block-caption">
						<p>Ryan Ruso</p>
						<p><em>Director of Oakland DOT</em></p>
					</div>
				</div>
				...
				<div class="column column-span-3">
					...
					<div class="block-caption">
						<p>Robin Hutcheson</p>
						<p><em>Ciry of Minneapolis Public Works DIrector</em></p>
					</div>
				</div>
				...
				<div class="column column-span-3">
					...
					<div class="block-caption">
						<p>Mark de la Vergne</p>
						<p><em>Cheif of Mobility Innovation Detroit</em></p>
					</div>
				</div>
				...
				<div class="column column-span-3">
					...
					<div class="block-caption">
						<p>Lisa Bender</p>
						<p><em>Minneapolis City Council President</em></p>
					</div>
				</div>
				...
				<div class="column column-span-3">
					...
					<div class="block-caption">
						<p>Kerry McCormack</p>
						<p><em>Cleveland City Councilman</em></p>
					</div>
				</div>
				...
				<div class="column column-span-3">
					...
					<div class="block-caption">
						<p>Joe Calabrese</p>
						<p><em>Cleveland Transit Boss</em></p>
					</div>
				</div>
				...
				<div class="column column-span-3">
					...
					<div class="block-caption">
						<p>Earl Blumenauer</p>
						<p><em>Congressman Portland Oregon</em></p>
						<p>Committee Chair</p>
					</div>
				</div>
