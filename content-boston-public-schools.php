...
<section class="page-section mt-2" style="background-color: #D6EFFD;">
	<figure class="alignnone mt-nudge">
		<div style="overflow:hidden; position: relative;">
			...
			<<img src="<?php echo os_path('DBPS-Parallax.jpg', 'dbps') ?>" srcset="<?php echo os_path('DBPS-Parallax.jpg', 'dbps') ?> 1x, <?php echo os_path('DBPS-Parallax.jpg', 'dbps') ?> 2x" width="1600" height="1008">
		</div>
...
<section id="solution" class="page-section" style="background-color: #D6EFFD; padding-bottom: 100px">
	...
	<div class="outer-container">
		<p class="h2 future-A h3 inner-container"><a href="https://discover.bostonpublicschools.org" class="cta-link" target="_blank">discover.bostonpublicschools.org <span class="icon arnhem rotate-cc-45">&rarr;</span></a></p>
	</div>
