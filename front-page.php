			...
			<ul class="client-list list-unstyled clearfix hug">
				<li class="tile push-triple layout-image-right">
					...
					<div class="tile-content push">
						...
						<p class="push"><a href="http://nytimes.com/timesjourneys" target="_blank">nytimes.com/timesjourneys</a></p>
						...
						<p class="push"><a href="http://nytedu.com" target="_blank">nytedu.com</a></p>
					</div>
				</li>
			...
			<ul class="client-list list-unstyled clearfix hug">
				<li class="tile push-triple layout-image-right">
					...
					<div class="tile-content push">
						...
						<p class="push"><a href="http://bam.org/visit" target="_blank">bam.org/visit</a></p>
					</div>
				</li>
				<li class="tile push-triple layout-half left">
					<div class="tile-content push">
						...
						<p class="push"><a href="http://orpheusnyc.org" target="_blank">orpheusnyc.org</a></p>
					</div>
				</li>
				<li class="tile push-triple layout-half right">
					<div class="tile-content push">
						...
						<p class="push"><a href="http://nationalboardofreview.org">nationalboardofreview.org</a></p>
					</div>
				</li>
				<li class="tile push-triple layout-image-left">
					...
					<div class="tile-content push">
						...
						<p class="push"><a href="http://gibneydance.org" target="_blank">gibneydance.org</a></p>
					</div>
				</li>
			</ul>
			...
			<ul class="client-list list-unstyled clearfix hug">
				<li class="tile push-triple layout-half left">
					<div class="tile-content push">
						...
						<p class="push"><a href="http://guittard.com" target="_blank">guittard.com</a></p>
					</div>
				</li>
				<li class="tile push-triple layout-half right">
					<div class="tile-content push">
						...
						<p class="push"><a href="http://carrmclellan.org" target="_blank">carrmclellan.org</a></p>
					</div>
				</li>
				<li class="tile push-triple layout-half left">
					<div class="tile-content push">
						...
						<p class="push"><a href="http://worldstrides.com" target="_blank">worldstrides.com</a></p>
					</div>
				</li>
			</ul>
