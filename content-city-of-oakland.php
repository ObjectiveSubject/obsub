...
<section id="solution" class="page-section " style="background-color: #E0F3F2; padding-bottom: 200px">
	...
	<div class="outer-container">
		<div class="inner-container">
			...
			<p class="h2 future-A h3"><a href="http://design.oaklandca.gov/" class="cta-link" target="_blank">design.oaklandca.gov <span class="icon arnhem rotate-cc-45">&rarr;</span></a></p>
		</div>
	</div>
