...
<section id="solution" class="page-section">
	...
	<figure data-delay="0" data-hold="3000" data-duration="2000" data-type="fadeOutReveal" class="outer-container cycle-each mt-3">
		<div class="outer-container">
	...
	<figure class="alignnone mt-3">
		<img src="<?php echo os_path('static-lines.png', 'gibney') ?>" srcset="<?php echo os_path('static-lines.png', 'gibney') ?> 1x, <?php echo os_path('static-lines@2x.png', 'gibney') ?> 2x" width="1600" height="1008" alt="Old Architecture">
		<div class="outer-container">
	...
	<figure class="outer-container mt-3">
	...
	<div data-offset="0.25" class="outer-container mt-3 active-on-inview">
	...
	<div class="outer-container">
		<div class="inner-container">
			<p class="h2 future-A h3 mt-4"><a href="http://gibneydance.org/" class="cta-link" target="_blank">gibneydance.org <span class="icon arnhem rotate-cc-45">&rarr;</span></a></p>
		</div>
	</div>
